<template>
  <div class="product-area">
    ...
    <el-table :data="pagedProductList" stripe style="width: 100%">
      ...
      <el-table-column prop="id" label="硅片Id" width="80">
      </el-table-column>
      <el-table-column prop="name" label="硅片名" width="220">
      </el-table-column>
      ...
      <el-table-column prop="category" label="类型" width="220">
      </el-table-column>
      <el-table-column prop="mix" label="掺杂" width="220">
      </el-table-column>
      <el-table-column prop="resistance" label="电阻" width="220">
      </el-table-column>
      <el-table-column prop="surface" label="表面" width="220">
      </el-table-column>
      <el-table-column prop="crystallinePhase" label="晶相" width="220">
      </el-table-column>
    ...
    >
      <div>
        ...
        <p>产品总价: {{ purchaseData.price * purchaseQuantity }} &nbsp;元</p>
      </div>
...
<script>
import { getSilicon, addProductOrder } from "../../network/mall";
