<template>
  <div class="product-area">
    ...
    <el-table :data="pagedProductList" stripe style="width: 100%">
      ...
      <el-table-column prop="id" label="材料Id" width="80"> </el-table-column>
      <el-table-column prop="name" label="材料名" width="220">
      </el-table-column>
      <el-table-column prop="cost" label="贵金属材料成本" width="100">
      </el-table-column>
...
<script>
import { getMaterialList, addProductOrder } from "../../network/mall";
