  ...
  <div class="equbg">
    ...
    <div class="equList">
      ...
      <el-table
        ...
        height="250"
      >
        <el-table-column fixed prop="deviceTypeId" label="类别ID" width="150">
        </el-table-column>
        <el-table-column prop="typeName" label="类别名" width="120">
        </el-table-column>
      </el-table>
    </div>
    <div class="equAdd" v-if="this.$store.state.cu_role === 'admin'">
      ...
      <el-form
        ...
        class="demo-ruleForm"
      >
        <el-form-item label="分类名" prop="newTypeName">
          <el-input
        ...
        <el-form-item>
          <el-button type="primary" @click="submitForm('equcateForm')"
            >添加</el-button
          >
        </el-form-item>
      </el-form>
    ...
    <div class="equUpdate" v-if="this.$store.state.cu_role === 'admin'">
      ...
      <el-form
        ...
        class="demo-ruleForm"
      >
        <el-form-item label="类型id" prop="deviceTypeId">
          <el-select v-model="eqpcateUpdateForm.deviceTypeId" placeholder="选择分类id">
            <el-option
        ...
        <el-form-item label="类型名" prop="newTypeName">
          <el-input
        ...
        <el-form-item>
          <el-button type="primary" @click="updateForm('eqpcateUpdateForm')"
            >更新</el-button
          >
        </el-form-item>
      </el-form>
    ...
    updateForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          updateSingleDeviceType(this.eqpcateUpdateForm.deviceTypeId,this.eqpcateUpdateForm.newTypeName)
          .then(res=>{
            //处理返回的相应数据
            const data = res.data
            console.log(data);
